...
const TRANSLATIONS = {
  en: {
    ...
    "home.subtitle": "Run text detection and recognition locally in your browser with oar-ocr-wasm, onnxruntime-web, and on-demand PP-OCRv6 models.",
    ...
    "ocr.subtitle": "Use oar-ocr-wasm with onnxruntime-web and PP-OCRv6 tiny/small/medium models fetched on demand.",
    ...
    "ocr.initialStatusTitle": "Ready for image",
    "ocr.initialStatusText": "Choose an image. The selected model downloads only when OCR starts.",
    ...
    "status.readyToLoad.title": "Ready to run",
    "status.readyToLoad.text": "Choose an image, then run OCR to download the selected model on demand.",
    ...
    "status.loadingFallback.title": "Ready to run",
    "status.loadingFallback.text": "The selected model will load when OCR starts.",
  ...
  zh: {
    ...
    "home.subtitle": "使用 oar-ocr-wasm、onnxruntime-web 和按需获取的 PP-OCRv6 模型，在浏览器本地完成文字检测与识别。",
    "home.start": "开始识别",
    ...
    "ocr.subtitle": "使用 oar-ocr-wasm 搭配 onnxruntime-web，按需获取 PP-OCRv6 tiny/small/medium 模型完成识别。",
    ...
    "ocr.initialStatusTitle": "等待选择图片",
    "ocr.initialStatusText": "请选择图片。所选模型只会在开始识别时下载。",
    ...
    "status.readyToLoad.title": "准备识别",
    "status.readyToLoad.text": "请选择图片，然后点击开始识别按需下载所选模型。",
    ...
    "status.loadingFallback.title": "准备识别",
    "status.loadingFallback.text": "所选模型会在开始识别时加载。",
    "ocr.imageMeta": "{name} · {width}×{height}",
